      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-2">
        <label className="text-[12px] font-semibold text-muted">
          ...
          <input
            ...
            className="mt-1 block w-full rounded-lg border border-line bg-base px-3 py-2 text-[14px] font-normal text-ink placeholder:text-muted focus:border-line-strong focus:outline-none"
          />
        </label>
        <label className="text-[12px] font-semibold text-muted">
          Work email
        ...
        <label className="text-[12px] font-semibold text-muted">
          ...
          <select
            ...
            className="mt-1 block w-full rounded-lg border border-line bg-base px-3 py-2 text-[14px] font-normal text-ink focus:border-line-strong focus:outline-none"
          >
            {ROLE_OPTIONS.map((o) => (
