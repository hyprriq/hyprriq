  ...
  properties: {
    evidence_items: {
      ...
      items: {
        type: "object",
        additionalProperties: false,
        required: ["evidence_id", "statement", "proposed_weight_key", "supporting_source_ids", "mapping_justification", "counter_evidence", "certainty", "confidence", "polarity", "subject_is_target"],
        properties: {
