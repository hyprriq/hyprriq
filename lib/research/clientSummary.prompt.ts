...
export const CLIENT_PROSE_SURFACE_RULE = [
  ...
  "classification'); first person; source ids; commentary on how many sources agreed; the words",
  "'corroborate' / 'corroborated' / 'corroboration' in any shell (measured 2026-08-20: the first",
  "client_summary ever produced used it and was gate-blocked — naming a source is fine, describing",
  "sources agreeing is not); or 'Amazon approved' / 'Amazon approval' in any shell including",
  "questions (ask about brand gating or required documentation instead).",
