...
const MUST_PASS: [string, string][] = [
  ...
  ["report how-to-read", "This report gives you one clear verdict, the single most important risk in plain language, findings across five assessment areas, an honest split between what we confirmed and what we could not, and a short checklist to run before you commit."],
