...
import { AREA_NAMES, CHIP_DEF_VERIFIED_CLAUSE, CHIP_DEF_ASSESSED_CLAUSE } from "@/lib/content/reportCopy";
...
// Both certainty words READ the single ruled definitions (founder-ruled: verified 2026-09-07,
// assessed 2026-09-08) — this surface had the substance right before the rulings and now cannot drift.
export const CERTAINTY = {
  ...
  assessed: `means ${CHIP_DEF_ASSESSED_CLAUSE}`,
  closing:
