...
**Status:** DRAFT — founder-review artifact. **No code until the founder approves + answers the OQs and signs off SO-1..SO-4** (same gate as H1–H6, all FROZEN; H6 frozen 2026-07-07).
...
## SIGN-OFFS for founder (each is a frozen-surface touch; veto any)
