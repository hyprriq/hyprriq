# HyprrIQ — Open Items Tracker v2

**Supersedes:** the 2026-07-04 tracker (which predates Tracks 3–6, Synthesis, and the hardening phases).
...
| 2.11 | Footer dead links, `#pricing` href | 🔴 | FA |
...
| 3.4 | Plan-upgrade button (missing) | 🔴 | FA |
...
| 3.9 | Settings page — never built | 🔴 | FA |
...
| 3.13 | Submission form: drag-drop upload, conditional notes | 🔴 | FA |
...
| 6.3 | Degraded-write tripwire | 🟡 | Built — surface `memory_write_failed` audits |
...
| 6.5 | G4 threshold recalibration | 🗄️ | Against the outcome corpus |
